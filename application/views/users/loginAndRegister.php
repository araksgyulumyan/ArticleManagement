...
<body>
<?php //var_dump($registerResponse);die;?>
<div class="container">
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form id="login-form" action="/users/login" method="post" role="form"
                                ...
                                <div class="form-group">
                                    <div class="infoMessage"><?php echo !empty($loginResponse->message) ? $loginResponse->message : ''; ?></div>
                                </div>
                                <div class="form-group">
                                    <?php if(!empty($registerResponse)) {
                                        foreach ($registerResponse->message as $message) {
